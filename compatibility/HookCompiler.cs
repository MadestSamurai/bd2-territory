...
public static class HookCompiler
{
    ...
    public static PreparedHook Prepare(string managed,BindingContract? contract=null)
    {
        ...
        var compilation=CSharpCompilation.Create("BD2Territory.Runtime14."+ToolFingerprint.Substring(0,16),sources,refs,new CSharpCompilationOptions(OutputKind.DynamicallyLinkedLibrary,optimizationLevel:OptimizationLevel.Release,platform:Platform.X64,deterministic:true));
