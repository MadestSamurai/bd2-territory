...
namespace BD2Territory
{
 ...
 {
  public const string RuntimeName="BD2Territory.Runtime16";
 ...
 public class TerritorySettings
 {
  ...
  public bool ValidSettings()=>CookingBatch>=1&&CookingBatch<=1000&&RecipeId>0&&IntervalMs>=100&&IntervalMs<=60000&&PlantingBudget>=0&&PlantingBudget<=10000000;
 }
